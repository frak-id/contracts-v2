...
forge script script/kernel/DeployModule.s.sol --rpc-url $ARBITRUM_SEPOLIA_RPC_URL --account testnetDeployer --sender 0x7caF754C934710D7C73bc453654552BEcA38223F --broadcast --verify
...
echo "Deploying kernel contracts to arbitrum"
forge script script/kernel/DeployModule.s.sol --rpc-url $ARBITRUM_RPC_URL --account mainnettDeployer --sender 0xaE4e57b886541829BA70eFC84340653c41e2908C --broadcast --verify