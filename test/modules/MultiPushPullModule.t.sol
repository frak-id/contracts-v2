...
import {MultiPushPullModule} from "src/modules/MultiPushPullModule.sol";

contract MultiPushPullModuleTest is Test {
    /// @dev The module we will test
    MockMultiPushPull private pushPullModule;
    ...
    function setUp() public {
        pushPullModule = new MockMultiPushPull();
    }
    ...
    function test_addReward_NotEnoughToken() public {
        ...
        vm.expectRevert(MultiPushPullModule.NotEnoughToken.selector);
    ...
    function test_addRewards() public {
        ...
        MultiPushPullModule.Reward[] memory rewards = new MultiPushPullModule.Reward[](2);

        rewards[0] = MultiPushPullModule.Reward(alice, 50 ether);
        rewards[1] = MultiPushPullModule.Reward(bob, 50 ether);
    ...
    function test_addRewards_NotEnoughToken() public {
        ...
        rewards[0] = MultiPushPullModule.Reward(alice, 50 ether);
        rewards[1] = MultiPushPullModule.Reward(bob, 51 ether);
...
contract MockMultiPushPull is MultiPushPullModule {
