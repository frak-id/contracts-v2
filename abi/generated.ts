...
export const paywallAbi = [
  {
    ...
    inputs: [
      ...
      { name: '_contentRegistry', internalType: 'address', type: 'address' },
    ],
    stateMutability: 'nonpayable',
  },
  {
    ...
    inputs: [
      { name: '_contentId', internalType: 'uint256', type: 'uint256' },
      {
        ...
        components: [
          ...
          { name: 'allowanceTime', internalType: 'uint32', type: 'uint32' },
          { name: 'isPriceEnabled', internalType: 'bool', type: 'bool' },
        ],
      },
    ],
    name: 'addPrice',
  ...
  {
    type: 'error',
    inputs: [{ name: 'priceIndex', internalType: 'uint256', type: 'uint256' }],
