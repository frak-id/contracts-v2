...
export const affiliationFixedCampaignAbi = [
  {
    type: 'constructor',
    inputs: [
      {
        name: '_config',
        internalType: 'struct AffiliationFixedCampaignConfig',
        type: 'tuple',
        components: [
          ...
          },
          {
            ...
            type: 'tuple',
            components: [
              { name: 'userPercent', internalType: 'uint256', type: 'uint256' },
              {
  ...
  },
  {
    ...
    outputs: [
      ...
      { name: 'bank', internalType: 'contract CampaignBank', type: 'address' },
    ],
  ...
  },
  {
    ...
    outputs: [
      ...
      { name: 'interactionContract', internalType: 'address', type: 'address' },
    ],
    stateMutability: 'view',
  },
  {
  ...
  },
  {
    type: 'function',
    inputs: [
      { name: '_productType', internalType: 'ProductTypes', type: 'uint256' },
    ],
...
export const affiliationRangeCampaignAbi = [
  {
    type: 'constructor',
    inputs: [
      {
        name: '_config',
        internalType: 'struct AffiliationRangeCampaignConfig',
        type: 'tuple',
        components: [
          { name: 'name', internalType: 'bytes32', type: 'bytes32' },
          {
          ...
          },
          {
            ...
            components: [
              ...
              { name: 'startReward', internalType: 'uint256', type: 'uint256' },
              { name: 'endReward', internalType: 'uint256', type: 'uint256' },
              { name: 'percentBeta', internalType: 'uint256', type: 'uint256' },
            ],
          },
        ],
      },
  ...
  { type: 'error', inputs: [], name: 'DistributionCapReached' },
  { type: 'error', inputs: [], name: 'InactiveCampaign' },
  { type: 'error', inputs: [], name: 'InvalidBetaValue' },
  { type: 'error', inputs: [], name: 'InvalidConfig' },
  { type: 'error', inputs: [], name: 'PointCalculationFailed' },
  { type: 'error', inputs: [], name: 'Reentrancy' },
  { type: 'error', inputs: [], name: 'Unauthorized' },
] as const
