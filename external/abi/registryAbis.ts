...
export const productRegistryAbi = [
    ...
    outputs: [
      {
        ...
        components: [
          ...
          { name: 'customMetadataUrl', internalType: 'string', type: 'string' },
        ],
      },
    ],
    stateMutability: 'view',
  ...
  },
  {
    type: 'function',
    inputs: [
      { name: '_baseMetadataUrl', internalType: 'string', type: 'string' },
    ],
    name: 'setMetadataUrl',
    outputs: [],
    stateMutability: 'nonpayable',
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: '_productTypes', internalType: 'ProductTypes', type: 'uint256' },
      { name: '_name', internalType: 'bytes32', type: 'bytes32' },
      { name: '_customMetadataUrl', internalType: 'string', type: 'string' },
    ],
    name: 'updateMetadata',
    outputs: [],
    stateMutability: 'nonpayable',
