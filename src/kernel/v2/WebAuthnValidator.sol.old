...
import {SIG_VALIDATION_FAILED} from "kernel-v2/common/Constants.sol";
...
contract WebAuthnValidator is IKernelValidator {
    ...
    function isPreCompiledP256Available() public view returns (bool) {
        ...
        (bool success, bytes memory data) = WebAuthnVerifier.PRECOMPILED_P256_VERIFIER.staticcall(testSignatureData);
